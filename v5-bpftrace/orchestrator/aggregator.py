#!/usr/bin/env python3
"""V5 aggregator -- reads bpftrace JSON streams plus resctrl and emits
...
Output format must match V1/V3/V4 byte-for-byte so IADA consumers work
unchanged.
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="V5 bpftrace IntP aggregator")
    ...
    parser.add_argument("--mon-group", default="intp-v5",
    ...
    try:
        if args.header:
            backends = (
                "# V5 bpftrace -- netp:tracepoint nets:tracepoint "
